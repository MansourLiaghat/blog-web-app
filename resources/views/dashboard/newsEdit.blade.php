                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input required id="con-name" name="name" type="text" class="form-control" value="طرح مجلس برای گرفتن مالیات از سفته بازها">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="3">زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</textarea>
                                        </div>
                                    </div>
                        ...
                        <span class="ql-formats">
                          ...
                          <button class="ql-clean"></button>
                                            ...
                                            <div class="bg-body border rounded-bottom h-300 overflow-hidden" id="quilleditor">
                                                <h2>حضور ایرانسل در رویداد فناورانه خودروهای آینده</h2>
                                                <br>
                                                <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط <b>فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. </b> کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. </p>
                                                ...
                                                <br>
                                                <ol>
                                                    <li>ین یک نوشته آزمایشی است که به طراحان و برنامه نویسان کمک میکند.</li>
                                                    <li>عزیزان با بهره گیری از این نوشته تستی و آزمایشی بتوانند نمونه تکمیل شده از پروژه و طرح خودشان را به کارفرما نمایش دهند. </li>
                                                    <li>طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد.</li>
                                    ...
                                    <div class="col-12 mt-4">
                                            ...
                                            <div class="row align-items-center mb-2">
                                                <div class="col-4 col-md-2">
                                                    <div class="position-relative">
                                                        <img class="rounded" src="{{Vite::images('blog/3by2/07.jpg')}}" alt="">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" rows="1">ورزش، سیاست، تکنولوژی</textarea>
