                                    ...
                                    <table class="table p-4 mb-0 table-shrink table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img class="rounded p-1 border" width="50px" src="{{Vite::images('avatar/vahid.jpeg')}}" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img class="rounded p-1 border" width="50px"
                                                     src="{{Vite::images('avatar/vahid.jpeg')}}" alt="">
                                                <span class="ms-1">وحید صالحی</span>
