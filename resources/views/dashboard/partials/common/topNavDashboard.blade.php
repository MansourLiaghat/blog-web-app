            ...
            <div class="nav flex-nowrap align-items-center">
                                ...
                                <ul class="list-group list-unstyled list-group-flush">
                                        ...
                                        <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                            <div class="me-3">
                                                <div class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" src="{{Vite::images('avatar/08.jpg')}}"
                                                         alt="avatar">
                                                </div>
                                            </div>
                                            <div>
                                    ...
                                    <li>
                                        <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                            <div class="me-3">
                                                <div class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" src="{{Vite::images
                                                    ('avatar/02.jpg')}}"
                                                         alt="avatar">
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
                                            <div class="me-3">
                                                <div class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" src="a{{Vite::images
                                                    ('avatar/03.jpg')}}"
                                                         alt="avatar">
                                                </div>
                                            </div>
                ...
                <div class="nav-item ms-2 ms-md-3 dropdown">
                    ...
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                        <img class="avatar-img rounded-circle" src="{{Vite::images('avatar/03.jpg')}}"
                             alt="avatar">
                    </a>
                        ...
                        <li class="px-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="avatar me-3">
                                    <img class="avatar-img rounded-circle shadow" src="{{Vite::images('avatar/03.jpg')}}"
                                         alt="avatar">
                                </div>
                                <div>
