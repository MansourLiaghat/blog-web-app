            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card card-overlay-bottom card-grid-lg card-bg-scale">
                        <img class="img-fluid" src="{{Vite::images('blog/1by1/01.jpg')}}" alt="">
                        <!-- Card featured -->
                    ...
                    <div class="card card-overlay-bottom card-grid-lg card-bg-scale">
                        ...
                        <div class="card-img-overlay">
							...
							دی، 1400</span>
                                ...
                                <h2 class="w-100 rounded px-3 py-3 slider-topic-title position-absolute bottom-0"><a
                                        class="text-white" href="post-single-4.html" class="">ده نشانه نسل جدید هدست های
                                        واقعیت مجازی سونی</a></h2>
                            </div>
                        </div>
                    </div>
