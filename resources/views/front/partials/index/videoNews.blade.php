        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card card-overlay-bottom  card-bg-scale">
                    <img class="img-fluid h-100" src="{{Vite::images('blog/1by1/01.jpg')}}" alt="">
                    <!-- Card featured -->
                    ...
                    <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                        <div class="w-100 mt-auto">
                            ...
                            <h2 class="text-white h1"><a href="post-single-4.html"
                                                         class="btn-link stretched-link text-reset">ده نشانه که
                                    نشان
                                        ...
                                        <div class="d-flex align-items-center text-white position-relative">
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle"
                                                     src="{{Vite::images('avatar/vahid.jpeg')}}"
                                                     alt="avatar">
                                            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        <div class="card card-overlay-bottom card-grid-sm card-bg-scale"
                             style="background-image:url({{Vite::images('blog/1by1/02.jpg')}});
                    ...
                    <div class="col-md-6">
                        <div class="card card-overlay-bottom card-grid-sm card-bg-scale"
                             style="background-image:url({{Vite::images('blog/1by1/03.jpg')}});
								background-position: center left; background-size: cover;">
                            <!-- Card Image overlay -->
                            <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                <div class="w-100 mt-auto">
                                    ...
                                    <!-- Card title -->
                                    <h4 class="text-white"><a href="post-single-4.html"
                                                              class="btn-link stretched-link text-reset">دلیل
                                            کاهش
                                            نرخ دلار </a></h4>
                                    <!-- Card info -->
                                    <ul
                    ...
                    <div class="col-md-6">
                        <div class="card card-overlay-bottom card-grid-sm card-bg-scale"
                             style="background-image:url({{Vite::images('blog/1by1/04.jpg')}});
								background-position: center left; background-size: cover;">
                            <!-- Card Image overlay -->
                            <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                <div class="w-100 mt-auto">
                                    ...
                                    <!-- Card title -->
                                    <h4 class="text-white"><a href="post-single-4.html"
                                                              class="btn-link stretched-link text-reset">جدول
                                            لیگ در
                                            پایان هفته</a></h4>
                                    <!-- Card info -->
                                    <ul
