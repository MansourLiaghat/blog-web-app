                    ...
                    <div class="tiny-slider-inner" style="float:left;"
                        ...
                        <div class="card">
                            ...
                            <div class="position-relative">
                                <img class="card-img" src="{{Vite::images('blog/4by3/07.jpg')}}"
                                     alt="Card image">
                        ...
                        <div class="card">
                            <!-- Card img -->
                            <div class="position-relative">
                                <img class="card-img" src="{{Vite::images('blog/4by3/08.jpg')}}"
                                     alt="Card image">
                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                    <!-- Card overlay bottom -->
                                    <div class="w-100 mt-auto">
                        ...
                        <div class="card">
                            <!-- Card img -->
                            <div class="position-relative">
                                <img class="card-img" src="{{Vite::images('blog/4by3/09.jpg')}}"
                                     alt="Card image">
                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                    <!-- Card overlay bottom -->
                                    <div class="w-100 mt-auto">
                        ...
                        <div class="card">
                            <!-- Card img -->
                            <div class="position-relative">
                                <img class="card-img" src="{{Vite::images('blog/4by3/10.jpg')}}"
                                     alt="Card image">
                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                    <!-- Card overlay Top -->
                                    <div class="w-100 mb-auto d-flex justify-content-end">
                        ...
                        <div class="card">
                            <!-- Card img -->
                            <div class="position-relative">
                                <img class="card-img" src="{{Vite::images('blog/4by3/11.jpg')}}"
                                     alt="Card image">
                                <div class="card-img-overlay d-flex align-items-start flex-column p-3">
                                    <!-- Card overlay bottom -->
                                    <div class="w-100 mt-auto">
                                    ...
                                    <li class="nav-item">
                                        <div class="nav-link">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="avatar avatar-xs">
                                                    <img class="avatar-img rounded-circle"
                                                         src="{{Vite::images('avatar/vahid.jpeg')}}" alt="avatar">
                                                </div>
                                                <span class="ms-3"><a href="#"
                                                                      class="stretched-link text-reset btn-link">وحید صالحی</a></span>
                                            </div>
