    ...
    <div class="container pe-0">
        <div class="d-flex justify-content-between align-items-baseline">
            <p class="fw-bold mb-3 fs-5 position-relative news-section-title">اخبار <span
                    class="fw-normal fs-6">ورزشی</span>
            </p>
        ...
        <div class="swiper" dir="rtl">
                    ...
                    <div class="card bg-lights p-4" style="box-shadow: 0px 5px 20px 0px rgba(69, 67, 96, 0.1);">
                        ...
                        <div class="position-relative">
                            <img class="card-img" style="margin-top: -60px;"
                                 src="{{Vite::images('blog/4by3/01.jpg')}}"
                                 alt="Card image">
            ...
            <!-- <div class="swiperSliderTrigger-pagination"></div> -->

            <!-- If we need navigation buttons -->
            <!-- <div class="swiperSliderTrigger-button-prev"></div>
    <div class="swiperSliderTrigger-button-next"></div> -->
        </div>
    </div>
</section>
